...
class ProfileScreenLogged extends StatefulWidget {
  const ProfileScreenLogged({super.key});

  @override
  State<ProfileScreenLogged> createState() => _ProfileScreenLoggedState();
}

class _ProfileScreenLoggedState extends State<ProfileScreenLogged> {
  @override
